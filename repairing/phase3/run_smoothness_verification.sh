...
# Wrapper script for Phase 3 Smoothness Verification
...
echo "Phase 3 Output: ${STAGE3_DIR}"
echo "Ground Truth:   ${GT_DIR}"

python verify_smoothness.py \
    --phase3_dir "$STAGE3_DIR" \
    --gt_dir "$GT_DIR"

echo "Verification Complete. Results saved to phase3_smoothness_metrics.csv (if implemented in script, otherwise check stdout)"
