...
# Data parameters
cfg["training_resolution"] = 64   # 阶段1：64³快速训练全局特征（262K点）
...
cfg["batch_size"] = 2  # 64³可以用batch_size=2
cfg["gradient_accumulation_steps"] = 2  # 有效batch_size = 4
cfg["eval_batch_size"] = 2  # 验证时用64³，batch_size=2
cfg["n_workers"] = 8

# Learning rate schedule (MultiStepLR with milestones)
cfg["use_cosine_schedule"] = False  # 改用MultiStepLR
...
cfg["sampling_bias_ratio"] = 0.5  # 初始50%边界采样，训练中动态调整
