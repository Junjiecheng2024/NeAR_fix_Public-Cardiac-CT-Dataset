"""
PyTorch Lightning Module for Myocardium NeAR Training
"""
import os
import sys
...
class MyocardiumNeARLightningModule(pl.LightningModule):
    """
    PyTorch Lightning wrapper for NeAR Myocardium training.
    """
