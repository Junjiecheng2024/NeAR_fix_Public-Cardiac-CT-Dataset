...
def calculate_ratios():
    csv_path = "/home/user/persistent/NeAR_fix_Public-Cardiac-CT-Dataset/repairing/phase2/phase2_cc_full_dataset.csv"
    ...
    for class_id in class_ids:
        ...
        # Mean voxel count across all samples (including those with 0 if any, though phase 2 shouldn't have 0 usually)
    ...
    # Estimate Background
    # Assuming no overlap (which is an approximation for Phase 2), Background = 100 - Sum(Foreground)
