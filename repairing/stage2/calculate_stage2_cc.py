...
def calculate_cc_stats():
    output_csv = 'stage2_cc_full_dataset.csv'
    ...
    print("\n--- Connected Components Statistics (Stage 2 Processed, 26-connectivity) ---")
    ...
    summary_df.to_csv('stage2_cc_summary.csv', index=False)
    print("\nSummary saved to stage2_cc_summary.csv")
