...
def main():
    parser = argparse.ArgumentParser(description="3D visualization of coronary segmentation")
    ...
    parser.add_argument("--output", type=str, default="/scratch/project_2016517/JunjieCheng/dataset/test")
