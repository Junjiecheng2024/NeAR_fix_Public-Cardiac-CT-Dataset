...
from repairing.phase3.phase3 import load_masks, resolve_priority_overlap, enforce_anatomical_constraints, CLASS_NAMES
...
if __name__ == "__main__":
    ...
    parser.add_argument("--phase2_dir", default=str(DEFAULT_DATA_ROOT))
